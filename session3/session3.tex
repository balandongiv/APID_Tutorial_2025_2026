...
For APID, the charter should remain connected to hydroponic agriculture and leave space for meaningful applied physics work such as sensing, flow control, structural design, or energy management.
...
\begin{enumerate}
    ...
    \item decide whether to adopt one draft or synthesise a new charter from multiple drafts; and
    \item refine the final wording until it is concise, clear, and shared by the full team.
\end{enumerate}
