...
\noindent
This is \textbf{Session 2} of the course.
...
Instead, we treat one Iris flower as normal Python variables so you can practice:
...
Run the script by clicking the Green "Run" button at the top-right corner in VS Code. You should see a printed summary of the flower's ID.
...
\subsection{Your Task: Experimenting with different Iris values}
...
First, try changing the flower ID value from \texttt{"flower1"} to \texttt{"flower\_2x"} in the code.
...
\subsection{Task 2: One Iris Flower as Variables}
...
\subsubsection{Your Task: Create a threshold variable}
\begin{enumerate}
...
\section{Session Task: Add a Second Flower with \_2 Suffix}
