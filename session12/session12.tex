...
\subsection{Activity 1: Define the Purpose of the Concept Test}
\textbf{Objective:}
...
\subsection{Activity 2: Choose a Survey Population} % if available
\textbf{Objective:}
...
\subsection{Activity 3: Choose a Survey Format} % if available
\textbf{Objective:}
...
\subsection{Activity 4: Communicate the Concept} % if available
\textbf{Objective:}
...
\subsection{Activity 1: Defining the Purpose of the Concept Test}
\begin{enumerate}
...
\subsection{Activity 2: Choosing a Survey Population} % if available
\begin{enumerate}
    \item Compile all the findings.
    \begin{enumerate}
...
\subsection{Activity 3: Choosing a Survey Format} % if available
\begin{enumerate}
    \item Compile all the findings.
    \begin{enumerate}
...
\subsection{Activity 4: Communicating the Concept} % if available
\begin{enumerate}
