...
Table~\ref{tab:session1-opportunity-areas} gives example product areas. These examples are intended to guide discussion, not to limit your group to a fixed list.
...
Use the table to identify which opportunities are most suitable for your group's interests and technical strengths.
...
Bring this summary to the next session and upload it to ITEL if the lecturer requests a submission. A clear decision here will make later work on planning, customer needs, and specifications much easier.
