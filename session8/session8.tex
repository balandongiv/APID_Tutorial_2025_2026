...
Table~\ref{tab:session8-metric-definition} gives a recommended format.
...
The need-metric matrix shows whether the chosen metrics cover the important needs. This is useful for checking whether any major need has been forgotten or whether several metrics are measuring the same issue.
