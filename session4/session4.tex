...
\textbf{Objective:} \\
The objective of this activity is to guide you in creating opportunities for innovation based on the innovation charter you developed in Session \ref{section:opportunity identification part 1}. After completing this activity, it is expected that you can explore new ideas that align with the objectives and boundaries outlined in the charter.

\vspace{10pt} 

\noindent To create opportunities for innovation based on the innovation charter you drafted in Session \ref{section:opportunity identification part 1}, follow these steps:
\begin{enumerate}
    \item Refer to the innovation charter you developed in Session \ref{section:opportunity identification part 1} as a guide for generating new opportunities.
...
\begin{enumerate}
    \item Refer to the innovation charter that the team developed in Session \ref{section:opportunity identification part 1} as a compass for this activity.
